  ...
  children:
    <Stack alignItems={'center'} justifyContent={'center'} width={'100%'} height={'100%'}>
      ...
      <Stack mt={4} width={700} direction={'row'} alignItems={'center'} justifyContent={'space-between'}>
        ...
        <Box mr={-20}>
          <PlayGameButton gameLink={'https://icm-project.github.io/quick-draw/'} />
        </Box>
      </Stack>
    </Stack>,
  links: [
  ...
  children:
    <Stack alignItems={'end'} justifyContent={'center'} width={'100%'} height={'100%'}>
      ...
      <Stack width={'100%'} direction='row' alignItems={'center'} justifyContent={'space-between'}>
        ...
        <Box mr={-6}>
          <PlayGameButton gameLink={'https://icm-project.github.io/teachable-machine/'} />
        </Box>
      </Stack>
    </Stack>,
  links: [],
